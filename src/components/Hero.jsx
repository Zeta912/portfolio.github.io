  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black'>
        ...
        <div className='my-auto mx-auto'>
            <div className='col-span-1 my-auto mx-auto w-[300px] h-auto lg:w-[410px]'>
        ...
        <div className='col-span-2 px-5 my-auto'>
            ...
            <p className='text-white sm:text-lb my-6 lg:text-xl'>
                My name is Sebastian Aguilera and I'm a junior Web Dev and Web Designer
            </p>
